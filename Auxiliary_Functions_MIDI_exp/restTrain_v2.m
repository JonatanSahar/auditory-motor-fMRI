...
function data_table = restTrain_v2(rest_len, window, device, train_len, ...
    data_table, num_blocks, block_num, win_hight, win_width)
    rest_timing = tic;
    ...
    while time_point <= rest_len
        ...
        if keyIsDown
            ...
            if strcmp('p', KbName(key_pressed))
                [data_table] = pause_experiment(device, train_len, ...
                    window, data_table, num_blocks, rest_len, ...
