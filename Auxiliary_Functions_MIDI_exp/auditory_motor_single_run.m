function auditory_motor_single_run(window, device,...
    data_table, conditions, num_blocks, block_start_times, ...
    block_end_times, i_run, num_notes)
     ...
     for i_block = 1:num_blocks
         ...
         [start_time, duration] = processAndPlaybackMIDI(device, ...
                                                         num_notes, ...
                                                         window, ...
                                                         1, ...
                                                         i_block, ...
