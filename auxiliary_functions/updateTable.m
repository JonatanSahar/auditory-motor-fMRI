...
function table = updateTable(P, blockP, table)
    ...
    table.start_time(curr_row) = blockP.start_of_block_actual;
    table.play_duration(curr_row) = blockP.duration;
    table.last_press_time(curr_row) = blockP.start_of_block_actual + blockP.duration;
    table.end_time(curr_row) = blockP.end_of_block_actual;
